...
class GelfLogAppenderNettyUdpIntegrationTests {
    ...
    static void setupClass() throws Exception {
        ...
        //Fix flakiness (another test is initializing the RuntimeContainer with no address, making this test fail, so force a re-init)
        if (RuntimeContainer.isInitialized() && Objects.equals(RuntimeContainer.ADDRESS, "")) {
            RuntimeContainer.lookupHostname((message, e) -> System.out.println(message + "::" + e.getMessage()));
        }
