...
public class RuntimeContainerProperties {
     ...
     */
    public static final String PROPERTY_LOGSTASH_GELF_HOSTNAME = "gelf-logging4j.hostname";

    /**
     * Set this system property to a fully qualified hostname to use a fixed host name.
     */
    public static final String PROPERTY_LOGSTASH_GELF_FQDN_HOSTNAME = "gelf-logging4j.fqdn.hostname";

    /**
     * Set this system property to <code>true</code> to skip hosname resolution. The string <code>unknown</code> will be used as
     * hostname.
     */
    public static final String PROPERTY_LOGSTASH_GELF_SKIP_HOSTNAME_RESOLUTION = "gelf-logging4j.skipHostnameResolution";
     ...
     */
    public static final String PROPERTY_LOGSTASH_GELF_HOSTNAME_RESOLUTION_ORDER = "gelf-logging4j.resolutionOrder";
